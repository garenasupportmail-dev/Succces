...
# ============ SIMPLE EMOJIS (No tg-emoji tags) ============
EMOJIS = {
    "verified": "✅",
    "crown": "👑",
    "shield": "🛡️",
...
def get_emoji(name):
    """Get plain emoji - NO tg-emoji tags"""
...
def decorate(text):
    """Add emojis to each line - plain emojis only"""
    lines = text.split('\n')
    out = []
    for line in lines:
        if line.strip():
...
def format_deal_message(deal, action):
    """Format deal action messages - plain emojis"""
